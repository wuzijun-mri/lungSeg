...
# DEMO  
parser.add_argument('--final_model', type=str, default='PATH_TO_TRAINED_SEGMENTER')
parser.add_argument('--data_dir', type=str, default='PATH_TO_TEST_DATA')
...
#-- model path
model_path = opts.final_model

#-- infer result directory
infer_dir = 'PATH_TO_SAVE_PREDICTION'
